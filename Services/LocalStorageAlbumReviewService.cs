...
public class LocalStorageAlbumReviewService : IAlbumReviewService
{
    private const string StorageKeyPrefix = "albumtracker_reviews_";
    private const string AnonymousUser = "anonymous";

    private readonly IJSRuntime _js;
    private readonly AuthenticationStateProvider _authStateProvider;
    private Dictionary<string, AlbumReview>? _cache;
    private string? _cachedUserId;

    public LocalStorageAlbumReviewService(IJSRuntime js, AuthenticationStateProvider authStateProvider)
    {
        _js = js;
    ...
    public async Task SaveReviewAsync(string albumId, string comment)
    {
        ...
        _cache![albumId] = new AlbumReview
        {
            AlbumId = albumId,
            Comment = comment,
    ...
    private async Task EnsureLoadedAsync()
    {
        ...
        _cache = string.IsNullOrEmpty(json)
            ? []
            : JsonSerializer.Deserialize<Dictionary<string, AlbumReview>>(json) ?? [];
